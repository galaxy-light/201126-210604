...
namespace Address0303.Ui
{
    partial class UpdateForm : MaterialForm
    {
        ...
        private void Upaddrinfo()
        {
            ...
            if (exnamech.Checked == true)
            {
                for (int i = 0; i < addrList.Count; i++)
                {
                    ...
                    else if (exnamech.Checked == true && extelch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exnamech.Checked == true && exaddressch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exnamech.Checked == true && exemailch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
            ...
            else if (extelch.Checked == true)
            {
                for (int i = 0; i < addrList.Count; i++)
                {
                    ...
                    else if (extelch.Checked == true && exnamech.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (extelch.Checked == true && exaddressch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (extelch.Checked == true && exemailch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
            ...
            else if (exaddressch.Checked == true)
            {
                for (int i = 0; i < addrList.Count; i++)
                {
                    ...
                    else if (exaddressch.Checked == true && exnamech.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exaddressch.Checked == true && extelch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exaddressch.Checked == true && exemailch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
            ...
            else if (exemailch.Checked == true)
            {
                for (int i = 0; i < addrList.Count; i++)
                {
                    ...
                    else if (exemailch.Checked == true && exnamech.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exemailch.Checked == true && extelch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
                    else if (exemailch.Checked == true && exaddressch.Checked == true)
                    {
                        MessageBox.Show("중복 체크 되었습니다. 하나의 항목에만 체크해주세요.");
                        break;
                    }
        ...
        {
            MessageBox.Show("수정할 항목을 체크하고 데이터 입력 후 변경 버튼을 눌러주세요.");
        }
    }
}
