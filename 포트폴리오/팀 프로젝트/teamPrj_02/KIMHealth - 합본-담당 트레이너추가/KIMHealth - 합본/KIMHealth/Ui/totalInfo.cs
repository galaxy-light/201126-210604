...
namespace KIMHealth.DB
{
    public partial class totalInfo : Form
    {
        ...
        public totalInfo()
        {
            ...
            this.del_btn.BackColor = System.Drawing.Color.SteelBlue;
            this.del_btn.ForeColor = Color.White;
            this.t_del_btn.BackColor = System.Drawing.Color.SteelBlue;
            this.t_del_btn.ForeColor = Color.White;
            this.edit_btn.BackColor = System.Drawing.Color.SteelBlue;
            this.edit_btn.ForeColor = Color.White;
            this.t_edit_btn.BackColor = System.Drawing.Color.SteelBlue;
            this.t_edit_btn.ForeColor = Color.White;
        }
        ...
        private void dataGridView_member_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                ...
                m_trainer_txt.Text = member.Cells[12].Value.ToString();
                m_start_txt.Text = member.Cells[13].Value.ToString();
                m_end_txt.Text = member.Cells[14].Value.ToString();
        ...
        private void edit_btn_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               DB.DaoMs.DB_Update(nowSelectNum, m_name_txt.Text, m_phone_txt.Text, m_addr_txt.Text, m_age_txt.Text, m_gender_txt.Text,
                    ...
                    m_pt_txt.Text, m_trainer_txt.Text, m_start_txt.Text, m_end_txt.Text);
                uiRefresh();
            }
            catch (Exception ex)
            {
