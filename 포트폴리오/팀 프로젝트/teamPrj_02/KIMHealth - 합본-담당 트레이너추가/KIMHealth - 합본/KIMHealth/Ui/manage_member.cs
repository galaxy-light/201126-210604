...
namespace KIMHealth
{
    public partial class manage_member : Form
    {
        public manage_member()
        {
            ...
            this.serch_btn.BackColor = System.Drawing.Color.SteelBlue;
            this.serch_btn.ForeColor = Color.White;
        }
            ...
            if (comboBox1.Text == "회원번호")
            {
                ...
                else
                {
                    try
                    {
                        ...
                        m.m_trainer = ds.Tables[0].Rows[0]["m_trainer"].ToString();
