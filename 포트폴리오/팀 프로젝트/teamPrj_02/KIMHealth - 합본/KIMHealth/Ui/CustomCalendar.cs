            ...
            for (int i = 0; i < RowCount; i++)
            {
                for (int j = 0; j < ColumnCount; j++)
                {
                    ...
                    else
                    {
                        ...
                        //tb.MouseClick += new MouseEventHandler(likeCal_MouseClick);//첫 줄은 요일이다.
                        TB[j + ((i-1) * 7)] = tb;
                    }
        ...
        public void selectDate(DateTime DT)
        {
            ...
            for (int var = 1; var <= End; var++)
            {
                ...
                else
                {
                    ...
                    //TB[index].BorderStyle = System.Windows.Forms.BorderStyle.None;
                    //TB[index].BackColor = System.Drawing.Color.White;
                }
            }
        }
