...
namespace CarManager0323.DB
{
    class DaoOracle
    {
        ...
        public void makeTbCustomer()
        {
            try
            {
                string query = "create table Car_Customer (" + "cu_num int not null," + "cu_nm varchar(20) not null," +
                                 "cu_ph VARCHAR2(20) not null," + "cu_addr VARCHAR2(50) not null," +
                                 "cu_em VARCHAR2(20) null," + "constraint Car_Customer_pk primary key (cu_num))";
                cmd.Connection = conn;
                cmd.CommandText = query;
                cmd.ExecuteNonQuery();
        ...
        public void makeTbCar()
        {
            try
            {
                string query = "create table Car_Car (" + "ca_num int not null," + "ca_mod varchar(20) not null," +
                                 "ca_pri int not null," + "ca_col VARCHAR2(20) not null," +
        ...
        public void insertDeal()
        {
            try
            {
                string sql1 = "insert into Car_Deal (de_num, de_dat, de_senum, de_cunum, de_carnum) " +
